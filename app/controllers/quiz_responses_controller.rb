class QuizResponsesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @quiz_response.save
        format.html { redirect_to quiz_response_url(@quiz_response), notice: "Quiz response was successfully created." }
  ...
  def update
    respond_to do |format|
      if @quiz_response.update(quiz_response_params)
        format.html { redirect_to quiz_response_url(@quiz_response), notice: "Quiz response was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to quiz_responses_url, notice: "Quiz response was successfully destroyed." }
  ...
  private
    ...
    def quiz_response_params
      params.require(:quiz_response).permit(:response, :user_id, :quiz_question_id, :quiz_id)
    end
end
