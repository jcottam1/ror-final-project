...
class QuizResponsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quiz_response" do
    assert_difference("QuizResponse.count") do
      post quiz_responses_url, params: { quiz_response: { quiz_id: @quiz_response.quiz_id, quiz_question_id: @quiz_response.quiz_question_id, response: @quiz_response.response, user_id: @quiz_response.user_id } }
    end
  ...
  test "should update quiz_response" do
    patch quiz_response_url(@quiz_response), params: { quiz_response: { quiz_id: @quiz_response.quiz_id, quiz_question_id: @quiz_response.quiz_question_id, response: @quiz_response.response, user_id: @quiz_response.user_id } }
